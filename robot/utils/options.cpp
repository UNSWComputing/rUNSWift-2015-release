...
void populate_options(po::options_description &config_file_options) {
   ...
   camera_config.add_options()
      ...
      ("camera.top.vflip", po::value<int>()->default_value(1),
       "camera top vflip")
      //240
      ("camera.top.brightness", po::value<int>()->default_value(255),
       "camera top brightness")
      ("camera.top.contrast", po::value<int>()->default_value(64),
       "camera top contrast")
      //200
      ("camera.top.saturation", po::value<int>()->default_value(255),
      ...
      ("camera.bot.hflip", po::value<int>()->default_value(1),
       "camera bot hflip")
      ("camera.bot.vflip", po::value<int>()->default_value(0),
       "camera bot vflip")
      ("camera.bot.brightness", po::value<int>()->default_value(255),
       "camera bot brightness")
      ("camera.bot.contrast", po::value<int>()->default_value(60),
       "camera bot contrast")
      ("camera.bot.saturation", po::value<int>()->default_value(230),
