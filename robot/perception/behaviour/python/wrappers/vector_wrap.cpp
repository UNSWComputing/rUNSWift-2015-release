...
class_<std::vector<RobotInfo> >("RobotInfoVec")
   .def(vector_indexing_suite<std::vector<RobotInfo> >());
...
class_<std::vector<FootInfo> >("FootInfoVec")
   .def(vector_indexing_suite<std::vector<FootInfo> >());
