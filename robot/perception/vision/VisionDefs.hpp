...
#define MIN_ANGLE_BETWEEN_EDGE_LINES DEG2RAD(30)
//#define MIN_ANGLE_BETWEEN_FIELD_LINES DEG2RAD(50)
#define MAX_EDGE_DEVIATION_FROM_PERPENDICULAR DEG2RAD(15)
#define MIN_ANGLE_BETWEEN_CORNERS DEG2RAD(10)
