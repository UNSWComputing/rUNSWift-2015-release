...
\title{Stability Control through Machine Learned Behaviours}


% author names and affiliations
% use a multiple column layout for up to three different
% affiliations
\author{\IEEEauthorblockN{rUNSWift 2013 Open Challenge Entry}
...
\begin{figure}[!t]
\centering
\includegraphics[width=3.5in]{figures/RL_lean.png}
\caption{We model the Nao robots in (b) as a $23 DOF$ (Degree Of Freedome) system.}
\label{fig:lean}
\end{figure}
...
\begin{figure}[!t]
\centering
\includegraphics[width=3.5in]{figures/RL_policies.png}
...
B. Hengst, \emph{Reinforcement Learning of Bipedal Lateral Behaviour and Stability Control with Ankle-Roll Activation}, WSPC Proceedings.
